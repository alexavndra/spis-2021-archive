...
def render_mtokm_result():
    ...
    try:
        ...
        return render_template('mtokm_result.html', kilometers=km_result, miles = miles_result)
...
def ctof(ftemp):
   ...
   return (ftemp * (5.0 / 9.0)) + 32.0 # replace with correct formula
...
#    return "Hello from Leah's server!"
